...
@Slf4j
public class OnsPrepareEventListener implements ApplicationListener<ApplicationEnvironmentPreparedEvent> {
    ...
    public void onApplicationEvent(ApplicationEnvironmentPreparedEvent event) {
        if (StringUtils.isBlank(DEFAULT_BASE_PACKAGE)) {
            ...
            log.info("rocketmq ons queue current application package:{}", DEFAULT_BASE_PACKAGE);
        }
    }
}
