...
@ConditionalOnProperty(prefix = "com.cloud.rocket.v5x.consumer", name = "enable", havingValue = "true")
public class ConsumerAutoConfiguration {
    ...
    @Configuration
    @EnableConfigurationProperties(RocketmqProperties.class)
    @ConditionalOnProperty(value = "com.cloud.rocket.v5x.consumer.idempotent")
