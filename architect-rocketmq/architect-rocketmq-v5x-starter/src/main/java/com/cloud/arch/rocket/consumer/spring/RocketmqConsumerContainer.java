...
public class RocketmqConsumerContainer implements InitializingBean, DisposableBean {
    ...
    private void createAndStartConsumer() throws Exception {
        ...
        this.consumer = new DefaultMQPushConsumer(group,
                                                  ...
                                                  properties.getConsumer().isEnableTrace(),
                                                  properties.getConsumer().getTraceTopic());
        ...
        public ConsumeConcurrentlyStatus consumeMessage(List<MessageExt> msgs, ConsumeConcurrentlyContext context) {
            ...
            for (MessageExt messageExt : msgs) {
                try {
                    ...
                    log.warn("consume message failed,messageId:[{}],topic:[{}],tag:[{}],reconsumeTimes:{}",
                             messageExt.getMsgId(),
                             messageExt.getTopic(),
                             messageExt.getTags(),
            ...
            log.info("consume topic[{}] messages size:{} success,taken time {} ms.",
